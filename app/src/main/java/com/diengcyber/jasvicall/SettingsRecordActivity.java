...
public class SettingsRecordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AND_ID = Settings.Secure.getString(this.getContentResolver(), Settings.Secure.ANDROID_ID);
    ...
    public static class MainPreferenceFragment extends PreferenceFragmentCompat implements Preference.OnPreferenceChangeListener{
        ListPreference key_android_id, key_video_resolution, key_audio_source, key_video_encoder, key_video_fps, key_video_bitrate, key_output_format;
        ...
        public void onCreate(final Bundle savedInstanceState) {
            ...
            key_android_id = findPreference(getString(R.string.key_android_id));
        ...
        private void setPreviousSelectedAsSummary() {
            if (getActivity() != null) {
                ...
                String android_id = prefs.getString("key_android_id", null);
                ...
                if (android_id != null) {
                    int index = key_android_id.findIndexOfValue(android_id);
                    key_android_id.setTitle(AND_ID);
                }
